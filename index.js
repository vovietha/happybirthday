const contentLetterSrart_actived = "Vợ yêu ơi, em nhấn vào hộp quà sau đó nhấn vào bức thư để xem hết nhaaaa!!!!!!!!!!!!." //Lời mở đầu cho bức thư
const mainContentLetter = "Chúc mọi điều ước trong ngày sinh nhật của em đều trở thành hiện thực. Anh hi vọng ngày này năm sau và mãi mãi anh có thể ở bên em để cùng em chúc mừng sinh nhật. Sinh nhật vui vẻ vợ yêu nhé!" //Nội dung của bức thư
...
imgLetter.src = "./photo_2023-03-21_23-20-55.jpg"; //Hình ảnh xuất hiện trong nội dung của bức thư sau khi bức thư được viết ra hết
